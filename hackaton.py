...
while action != '0':
    ...
    hours_start = int(input('Введите время начала действия в часах (от 10 до 24 часов, 0 - остановить ввод):'))
    hours_end = int(input('Введите время конца действия в часах (от 10 до 24 часов, 0 - остановить ввод):'))
